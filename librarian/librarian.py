...
class Librarian(object):
    ...
    def __init__(self):
        ...
        Constructor
        '''
        self.iplayer_monitor=iplayer_monitor.IPlayerInfoParser()
        self.records=[]
    ...
    def look_for_new_files(self, info_stream):
        ...
        iplayer_list = self.iplayer_monitor.read_log(info_stream)
        for file_info in iplayer_list:
            ...
            if self.is_a_new_record(a_record):
                ...
                an_episode = iplayer_monitor.episode_factory(file_info)
