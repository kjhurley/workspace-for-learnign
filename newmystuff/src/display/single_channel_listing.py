...
under that a box containing 
    date and time of current program hard left against the margin. time since 
       start/time left hard agaist the right margin
    a paragrap of description of the show
under that a grid containing on each row:
    the time the program starts, the title of the program, start of the 
    description (cut off at the right edge)
under that a bottom line containing
    4 buttons - +1 day, -1 day, << page up, >> page down
    
    
the box with current program description should match the program 
line selected in the grid layout 
